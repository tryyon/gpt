...
export function CreateOrderForm() {
  ...
  const [selectedCustomer, setSelectedCustomer] = useState<CustomerFormData & { id: string } | null>(null);
      ...
      case 0:
        return (
          <Box>
            ...
            <CustomerSearch onCustomerSelect={(customer) => setSelectedCustomer(customer)} />
            {selectedCustomer && (
              <Paper 
                variant="outlined" 
                sx={{ 
