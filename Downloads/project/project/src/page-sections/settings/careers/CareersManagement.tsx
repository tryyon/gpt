...
const mockCareers: Career[] = [
  {
    ...
    requirements: [
      ...
      { value: 'Strong knowledge of React and Node.js' },
      { value: 'Experience with cloud platforms (AWS/GCP)' },
    ],
    responsibilities: [
      { value: 'Lead development of key platform features' },
      { value: 'Mentor junior developers' },
      { value: 'Contribute to system architecture decisions' },
      { value: 'Write clean, maintainable code' },
    ],
    isActive: true,
  ...
  },
  {
    ...
    requirements: [
      { value: 'Bachelor\'s degree in Computer Science or equivalent experience' },
      { value: '3+ years of full stack development experience' },
      { value: 'Proficiency in React, TypeScript, and Node.js' },
      { value: 'Experience with RESTful APIs and GraphQL' },
      { value: 'Strong understanding of database design and optimization' },
    ],
    responsibilities: [
      { value: 'Develop and maintain full stack web applications' },
      { value: 'Collaborate with product and design teams' },
      { value: 'Optimize application performance' },
      { value: 'Write unit tests and integration tests' },
      { value: 'Participate in code reviews and technical discussions' },
    ],
    isActive: true,
  ...
  },
  {
    ...
    requirements: [
      { value: 'Bachelor\'s degree in Business, Technology, or related field' },
      { value: '3+ years of product management experience' },
      { value: 'Strong analytical and problem-solving skills' },
      { value: 'Excellent communication abilities' },
    ],
    responsibilities: [
      { value: 'Define product vision and strategy' },
      { value: 'Work with stakeholders to gather requirements' },
      { value: 'Prioritize features and create roadmaps' },
      { value: 'Monitor product metrics and KPIs' },
    ],
    isActive: true,
