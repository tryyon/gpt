...
export function MainCategoryForm(props: any) {
  // Replace this with your actual form implementation
  return (
    <Box p={3}>
      <div>Main Category Form Placeholder</div>
      <Button variant="contained" onClick={() => props.onSubmit && props.onSubmit({})}>
        Submit
      </Button>
      <Button variant="text" onClick={props.onCancel} sx={{ ml: 2 }}>
        Cancel
      </Button>
    </Box>
  );
