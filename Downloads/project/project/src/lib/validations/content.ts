...
export const careerSchema = z.object({
  ...
  requirements: z.array(z.object({ value: z.string() })).min(1, 'At least one requirement is required'),
  responsibilities: z.array(z.object({ value: z.string() })).min(1, 'At least one responsibility is required'),
  isActive: z.boolean(),
  postedDate: z.date(),
});
...
export const brandAssetSchema = z.object({
  ...
  category: z.enum(['primary', 'secondary', 'monochrome', 'social', 'print', 'web', 'press']),
